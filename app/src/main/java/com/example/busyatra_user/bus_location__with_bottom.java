...
public class bus_location__with_bottom extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_bus_location2);
        ...
        final int firstFrameHeight = (int) (screenHeight * 0.80);
        ...
        Bus_location_Fragment_bottom firstFragment = new Bus_location_Fragment_bottom();
...
// Get the BottomSheetBehavior from the FrameLayout
        ...
        int peakHeightPixels = (int) (screenHeight * 0.20); // Replace with your desired value
